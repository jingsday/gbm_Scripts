...
setwd('/home/oleksii/Downloads/Jing_24/project_gbm/DATA_glioblastoma/GSE174554_RAW')

# get data location
dirs <- list.files(path = '/home/oleksii/Downloads/Jing_24/project_gbm/DATA_glioblastoma/GSE174554_RAW', recursive = F, full.names = F)
...
saveRDS(seurat.integrated,"/home/oleksii/Downloads/Jing_24/project_gbm/gbm_OUTPUT/global_gbm.rds")
